...
namespace TestLeaf.Helpers
{
	class CustomMethods : BasePage
	{
		...
		public static void CustomWaitMethod(IWebElement webElement)
		{
		...
		public static void CustomWaitMethodDisappear(IWebElement webElement)
		{
			WebDriverWait wait = new WebDriverWait(Driver, TimeSpan.FromSeconds(15));
			wait.Until(d =>
			{
		...
		public static void ActionsKeys(IWebElement webElement, string text)
		{
		...
		public static void KeyboardActions(IWebElement webElement)
        {
			Actions actions = new Actions(Driver);
